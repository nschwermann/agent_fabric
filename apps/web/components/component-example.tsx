...
function WalletExample() {
  ...
  return (
    <Example title="Wallet Connection" className="items-center justify-center">
      <Card className="w-full max-w-sm">
        <CardHeader>
          <CardTitle>Connect Wallet</CardTitle>
          <CardDescription>
            Sign in with your wallet to access the x402 Marketplace
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          {/* AppKit web component for wallet connection */}
          <appkit-button />
